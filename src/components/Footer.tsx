...
const Footer: React.FC = () => {
    return (
        <footer className="bg-fuchsia-900 text-white py-8 px-6 rounded-xl">
            <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
                {/* Logo and Description */}
                <div className="text-center md:text-left mb-4 md:mb-0">
                    <h2 className="text-2xl font-bold">Dapur Sehat</h2>
                    <p className="text-gray-300 mt-2">
                        Kami adalah pilihan unggulan di Bandung, menawarkan aneka hidangan 
                    </p>
                    <p className="text-gray-300">
                        istimewa dengan rasa yang tak terlupakan.
                    </p>
                </div>
