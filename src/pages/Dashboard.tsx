...
const Dashboard: React.FC = () => {
  return (
    <div className="flex flex-col items-center p-2 sm:p-4 md:p-16 min-h-screen bg-gray-100">
      ...
      {/* Slogan Section */}
      <div className="w-full bg-gradient-to-r from-fuchsia-950 to-pink-400 mt-4 p-2 sm:p-4 md:p-6 text-center rounded-lg shadow-lg">
        <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-white italic">Bergerak dalam dapur sehat, produksi makanan untuk katering</h1>
      </div>
        ...
        <div className="flex space-x-2 sm:space-x-4">
          ...
          <div className="min-w-[200px] sm:min-w-[250px] p-2 sm:p-4 bg-white rounded-lg shadow-md">
            <img
              ...
              className="w-full h-28 sm:h-32 md:h-40 object-cover rounded-lg mb-2 sm:mb-4"
            />
            <h3 className="text-sm sm:text-base md:text-xl font-bold text-purple-800">Catering</h3>
      ...
      <div className="flex flex-col md:flex-row items-start w-full bg-purple-50 rounded-lg shadow-lg p-6 md:p-8 mt-10">
        ...
        <div className="w-full md:w-1/2 mb-4 md:mb-0 md:mr-10">
          <h2 className="text-base sm:text-lg md:text-2xl font-semibold text-purple-700 mb-2">
      ...
      <div className="w-full mt-10">
        <h2 className="text-base sm:text-lg md:text-2xl font-semibold text-purple-700 mb-4">Lokasi Dapur Sehat PT Mitra Jembar Utami <p className='italic text-sm'>Jln. Darmita Atmadja, No. 25, Ganjar Sabar, Kec Nagreg, Kab. Bandung</p></h2>
